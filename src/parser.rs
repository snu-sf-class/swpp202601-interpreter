...
use crate::function::SwppFunction;
...
/// Preprocess the program by adding line numbers to each line, which is used for error handling
...
/// Parser for the whole program, which converts the program string into the global state of the program
pub fn total_program_parser(prog: &str) -> Vec<SwppFunction> {
